    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="img/kolam.jpeg" alt="First slide" width="1000" height="700">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="img/21.jpg" alt="Second slide" width="1000" height="700">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="img/gym.jpg" alt="Third slide" width="1000" height="700">
                      </div>
                      </div>
...
.about_area {
    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="img/gym.jpg" alt="First slide" width="1000" height="700">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="img/21.jpg" alt="Second slide" width="1000" height="700">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="img/kolam.jpeg" alt="Third slide" width="1000" height="700">
                      </div>
                      </div>
                </div>
    <!-- about_info_area_start -->
