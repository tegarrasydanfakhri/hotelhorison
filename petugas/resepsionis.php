...
<head>
  ...
  <title>Resepsionis Horison</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar elevation-3">
    ...
    <a href="#" class="brand-link">
      <img src="../template2/dist/img/horison2.png" alt="AdminLTE Logo" style="opacity: .8">
      <span  class=" brand-text font-weight-light" style="text-center"><b><b>HORISON HOTEL</b></b></span>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../template1/img/comment/comment_1.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><center>SELAMAT DATANG RESEPSIONIS<center></h1>
            <h1><center>HOTEL HEBAT</center></h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022-2023 <a href="https://instagram.com/im.stay1/">TEGAR RASYDAN FAKHRI</a>.</strong> All rights reserved.
  </footer>
