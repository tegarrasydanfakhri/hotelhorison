...
<div class="wrapper">
  ...
  <aside class="main-sidebar elevation-3">
    ...
    <a href="#" class="brand-link">
      ...
      <span class="brand-text font-weight-light"><b><b>HORISON HOTEL</b></b></span>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../template1/img/comment/comment_3.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><center>SELAMAT DATANG ADMIN<center></h1>
            <h1><center>HOTEL HORISON</center></h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
