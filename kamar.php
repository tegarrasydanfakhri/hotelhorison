    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="img/deluxeroom.jpg" alt="First slide" width="1000" height="700">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="img/president.jpeg" alt="Second slide" width="1000" height="700">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="img/suite.jpg" alt="Third slide" width="1000" height="700">
                      </div>
                      </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center mb-100">
                        <span><h1><b>Kamar<b></h1></span>
                        <h3>Pilih yang sesuai</h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="room_thumb">
                    ...
                    <div class="room_heading d-flex justify-content-between align-items-center">
                        <div class="room_heading_inner">
                            ...
                            <span>  <?php echo $row ['harga'] ?> /Malam</h2>
                            
                            <h3><?php echo $row ['fasilitas_kamar'] ?></h3>
                            
                            <span><?php echo $row ['jumlah_kasur'] ?> Bed</span>
                            <h3><?php echo $row ['nama_kamar'] ?></h3>
                        <a href="#test-form" class="popup-with-form">book now</a>
                        </style>
                        </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> by <a href="https://instagram.com/im.stay1/" target="_blank">TEGAR RASYDAN FAKHRI</a> 
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                    <div class="col-xl-4 col-md-5 col-lg-3">
                        <div class="socail_links">
                            <ul>
                                <li>
                                    <a href="https://instagram.com/im.stay1/">
